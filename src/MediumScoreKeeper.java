...
public class MediumScoreKeeper implements ScoreKeeper{
	private int red = 0;
	private int green = 0;
	private int yellow = 0;
	private int blue = 0;
	
	private int BLUE_LIMIT = 7;
	private int RED_LIMIT = 10;
	private int YELLOW_LIMIT = 15;
	private int GREEN_LIMIT = 20;
